...
class IDLGrammarSpec : FreeSpec({
    "positive multiple service with multiple nested parameters" - {
        ...
        val methods = listOf(
            method(IDLType.Id("f"), listOf(IDLArgType("test", IDLType.Constructive.Blob), IDLType.Constructive.Opt(IDLType.Primitive.Bool).asArg()), emptyList(), listOf(IDLFuncAnn.Oneway)),
            method(IDLType.Id("g"), listOf(IDLType.Id("my_type"), IDLType.Id("List"), IDLType.Constructive.Opt(IDLType.Id("List"))).map { it.asArg() }, listOf(IDLType.Primitive.Integer.asArg()), listOf(IDLFuncAnn.Query)),
            method(IDLType.Id("h"), listOf(IDLType.Constructive.Vec(IDLType.Constructive.Opt(IDLType.Primitive.Text)), IDLType.Constructive.Variant(listOf(fieldType("A", IDLType.Primitive.Natural), fieldType("B", IDLType.Constructive.Opt(IDLType.Primitive.Text)))), IDLType.Constructive.Opt(IDLType.Id("List"))).map { it.asArg() }, listOf(IDLType.Constructive.Record(listOf(fieldType("0x2a", IDLType.Constructive.Record(emptyList())), fieldType("id", IDLType.Primitive.Natural)))).map { it.asArg() }, emptyList()),
    ...
    "positive single service" - {
        listOf(
            ...
            row("getInHex", listOf(IDLType.Primitive.Text.asArg()), listOf(IDLType.Constructive.Opt(IDLType.Primitive.Nat8).asArg())),
            row("putInHex", listOf(IDLType.Primitive.Text, IDLType.Primitive.Text).map { it.asArg() }, emptyList()),
            row("get", listOf(IDLType.Constructive.Vec(IDLType.Primitive.Nat8).asArg()), listOf(IDLType.Constructive.Opt(IDLType.Constructive.Vec(IDLType.Primitive.Nat8)).asArg())),
            row("put", listOf(IDLType.Constructive.Vec(IDLType.Primitive.Nat8), IDLType.Constructive.Vec(IDLType.Primitive.Nat8)).map { it.asArg() }, listOf(IDLType.Primitive.Bool.asArg())),
    ...
    "!positive single service with parameters" - {
        listOf(
            ...
            row("getWithTrace", listOf(IDLType.Constructive.Vec(IDLType.Primitive.Nat8), IDLType.Id("Bucket")).map { it.asArg() }, listOf(IDLType.Constructive.Opt(IDLType.Constructive.Vec(IDLType.Primitive.Nat8)).asArg())),
            row("putWithTrace", listOf(IDLType.Constructive.Vec(IDLType.Primitive.Nat8), IDLType.Constructive.Vec(IDLType.Primitive.Nat8), IDLType.Id("Bucket")).map { it.asArg() }, listOf(IDLType.Primitive.Bool.asArg())),
        ).map { (methodName: String, arguments: List<IDLArgType>, results: List<IDLArgType>) ->
            val types = listOf(
                IDLDef.Type("Key", IDLType.Constructive.Record(listOf(fieldType("preimage", IDLType.Constructive.Vec(IDLType.Primitive.Nat8)), fieldType("image", IDLType.Constructive.Vec(IDLType.Primitive.Nat8))))),
                IDLDef.Type("List", IDLType.Constructive.Opt(IDLType.Constructive.Record(listOf(fieldType(0, IDLType.Id("Key")), fieldType(1, IDLType.Id("List")))))),
    ...
    "positive single service with recursive parameters" - {
        val types = listOf(
            IDLDef.Type("Version_3", IDLType.Constructive.Variant(listOf(fieldType("Version", IDLType.Primitive.Natural)))),
            IDLDef.Type("Version_2", IDLType.Id("Version_3")),
            IDLDef.Type("Version", IDLType.Id("Version_2")),
            IDLDef.Type("Mode_3", IDLType.Constructive.Variant(listOf(fieldType("Kanji", IDLType.Primitive.Null), fieldType("Numeric", IDLType.Primitive.Null), fieldType("EightBit", IDLType.Primitive.Null), fieldType("Alphanumeric", IDLType.Primitive.Null)))),
            IDLDef.Type("Mode_2", IDLType.Id("Mode_3")),
            IDLDef.Type("Mode", IDLType.Id("Mode_2")),
            IDLDef.Type("ErrorCorrection_3", IDLType.Constructive.Variant(listOf(fieldType("H", IDLType.Primitive.Null), fieldType("L", IDLType.Primitive.Null), fieldType("M", IDLType.Primitive.Null), fieldType("Q", IDLType.Primitive.Null)))),
            IDLDef.Type("ErrorCorrection_2", IDLType.Id("ErrorCorrection_3")),
            IDLDef.Type("ErrorCorrection", IDLType.Id("ErrorCorrection_2")),
        )
        val methods = listOf(method(IDLToken.TextVal("encode"), listOf(IDLType.Id("Version"), IDLType.Id("ErrorCorrection"), IDLType.Id("Mode"), IDLType.Primitive.Text).map { it.asArg() }, listOf(IDLType.Primitive.Text.asArg())))
        val program = program(methods, types)
        IDLGrammar.parseToEnd(program.println().transpile().toString()) shouldBe program
    }
    "positive multiple services with parameters and annotations" - {
        val types = listOf(
            IDLDef.Type("Value", IDLType.Constructive.Record(listOf(fieldType("i", IDLType.Primitive.Integer), fieldType("n", IDLType.Primitive.Natural)))),
            IDLDef.Type("Sign", IDLType.Constructive.Variant(listOf(fieldType("Plus", IDLType.Primitive.Null), fieldType("Minus", IDLType.Primitive.Null)))),
            IDLDef.Type("Message", IDLType.Constructive.Record(listOf(fieldType("sender", IDLType.Primitive.Text), fieldType("message", IDLType.Primitive.Text)))),
